  ...
  return (
    <header className="grid grid-cols-2 gap-x-4 w-full mx-auto z-10 border-b border-black pb-4">
      ...
      <div className="flex space-x-4 items-center justify-end">
        ...
        <button className="flex items-center px-2 py-1 border rounded-full font-base bg-gradient-to-r from-primary to-primary-dark text-gray-200 hover:scale-105 transition-all duration-200 hover:text-gray-900">
